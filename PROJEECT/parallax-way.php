...
<head>
	...
	<link href="lean-slider_v1.0/lean-slider.css" rel="stylesheet">
...
function initialize() {
  var mapOptions = {
    zoom: 10,
    center: new google.maps.LatLng(40.45, -80)
  };
  map = new google.maps.Map(document.getElementByClas('map-canvas'),
      mapOptions);
}
    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <nav>
                <ul>
                    <li>
                        <a href="Login.php" tabindex="5" title="Login" target="_self">Login</a>
                    </li>
                    <li>
                        <a href="Register.php" tabindex="4" title="Home" target="_self">Registration</a>
                    </li>
                    <li>
                        <a href="index.php" tabindex="1" title="Home" target="_self">Home</a>
                    </li>
                    <li>
                        <a href="about.php" tabindex="2" title="About Parallax" target="_self">About</a>
                    </li>
                    <li>
                        <a class="current" href="parallax-way.php" tabindex="3" title="The Parallax Way" target="_self">The Parallax Way</a>
                    </li>
                    <li>
                        <a href="energy.php" tabindex="4" title="Energy Holdings" target="_self">Energy Holdings</a>
                    </li>
                </ul>
            </nav>
            <!--End nav-->
