    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <nav>
                <ul>
                     <li>
                        <a href="Login.php" tabindex="4" title="Home" target="_self">Login</a>
                    </li>
                     <li>
                    ...
                    <li>
                        <a class="current" href="energy.php" tabindex="4" title="Energy Holdings" target="_self">Energy Holdings</a>
                    </li>
                </ul>
            </nav>
            <!--End nav-->
