...
<body>
    ...
    <div id="wrapper">
            ...
            <nav>
                <ul>
                    <li>
                     ...
                     <li>
                        <a  href="Register.php" tabindex="1" title="Home" target="_self">Register</a>
                    </li>
                    <li>
                        <a class="current" href="index.php" tabindex="1" title="Home" target="_self">Home</a>
                    </li>
                    <li>
                        <a href="about.php" tabindex="2" title="About Parallax" target="_self">About</a>
                    </li>
                    <li>
                        <a href="parallax-way.php" tabindex="3" title="The Parallax Way" target="_self">The Parallax Way</a>
                    </li>
                    <li>
        ...
        <!--Begin featureImage-->
     	<div id = "slider">
		<div class="slide1">
		<img src="images/featureImage-Home_v2.jpg" alt="">
		</div>
		<div class="slide2">
		<img src="images/featureImage-Home_v2b.jpg" alt="">
		</div>
		<div class="slide3"><img src="images/featureImage-Home_v2c.jpg" alt="">
		</div>
		</div>
