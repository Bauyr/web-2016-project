    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <nav>
                <ul>
                    <li>
                        <a href="parallax-way.php" tabindex="4" title="Logout" target="_self">Logout</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="current" href="parallax-way2.php" tabindex="3" title="The Parallax Way" target="_self">The Parallax Way</a>
                    </li>
                    <li>
