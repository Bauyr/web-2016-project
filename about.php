    ...
    <div id="wrapper">
        ...
        <header>
            ...
            <nav>
                <ul>
                    <li>
                        <a href="Login.php" tabindex="4" title="Login" target="_self">Login</a>
                    </li>
                    <li>
                        <a href="Register.php" tabindex="4" title="Register" target="_self">Registration</a>
                    </li>
                    <li>
                        <a href="index.php" tabindex="1" title="Home" target="_self">Home</a>
                    </li>
                    <li>
                        <a class="current" href="about.php" tabindex="2" title="About Parallax" target="_self">About</a>
                    </li>
                    <li>
